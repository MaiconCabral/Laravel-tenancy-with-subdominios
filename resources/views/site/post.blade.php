...
<html lang="en">
  <head>
    ...
    <title> {{ session('tenant')['name'] ?? ''}} - Blog</title>
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 mb-3">
               <img src="{{$posts->url_cover}}" style="width: 100%;height: 600px;" class="img-fluid mb-3" alt="...">

               <h2 class="h2 text-center mb-3">{{$posts->title}}</h2>
